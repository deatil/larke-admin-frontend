  ...
  <div class="app-container">
    <el-card>
      ...
      <div class="filter-container">
        <el-button class="filter-item" style="margin-right: 10px;" type="warning" @click="handleDeleteList">
          删除选中
        </el-button>  
        ...
        <el-select v-model="listQuery.method" placeholder="请求方式" clearable style="width: 140px;margin-left: 10px;" class="filter-item">
        ...
        <el-button class="filter-item" style="margin-left: 10px;" type="danger" @click="handleClear">
          清空日志
        </el-button>
      </div>
  ...
  methods: {
    ...
    handleDeleteList() {
      this.$confirm('确认要删除选中的日志吗？', '提示', {
        ...
        const thiz = this
        deleteLog(this.selectedData.join(',')).then(() => {
          this.$message({
            message: '删除选中的日志成功',
            type: 'success',
            duration: 3 * 1000,
